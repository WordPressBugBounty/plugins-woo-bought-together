...
= 8.0.0 =
* Updated: Optimized the code for item quantity
...
= 7.8.2 =
* Fixed: Can't save selected products
...
= 7.6.8 =
* Fixed: Position "Above summary"
* Fixed: Minor CSS/JS issues in the backend

= 7.6.7 =
* Fixed: Cart/Checkout Blocks

= 7.6.6 =
* Added: Sortable for products in Smart Rules
...
= 7.6.2 =
* Added: Before/after text in each rule
* Fixed: Minor CSS/JS issues
...
= 7.5.7 =
* Fixed: Minor CSS/JS issues for the carousel layout

= 7.5.6 =
* Updated: JS issues when switching variations

= 7.5.5 =
* Updated: Minor JS issues on frontend

= 7.5.4 =
* Updated: Minor CSS/JS issues
...
= 7.4.1 =
* Fixed: Critical Error when adding products to the cart
...
* Updated: Compatible with WPC Variation Swatches
